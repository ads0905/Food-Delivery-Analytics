...
![Query output - part 1]
(screenshots1
top 10_customers_output1.png)


![Query output - part 2]
(screenshots1
top 10_customers_output2.png)
...
![Query output - part 1 ]
(screenshots1
avg_order_value_noida output1.png)

![Query output - part 2 ]
(screenshots1
avg_order_value_noida output2.png)
...
![Query output - part 1 ]
(screenshots1
high_value_customers output1.png)

![Query output - part 2 ]
(screenshots1
high_value_customers output2.png)
...
![Query output - part 1 ]
(screenshots1
multiple_orders output1.png)

![Query output - part 2 ]
(screenshots1
multiple_orders output2.png)
